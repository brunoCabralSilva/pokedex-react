...
export default function NameNumber() {
  ...
  return(
      <div className="w-full sm:w-full mx-auto px-1">
        <div className="bg-black/75 h-35vh sm:h-75vh w-full flex-col items-center mb-1">
          ...
          <div className="w-full sm:h-full flex flex-col sm:flex-row items-center sm:items-start justify-center">
            <input
              type="text"
