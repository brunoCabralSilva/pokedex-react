  ...
  return (
    <div className="flex flex-col items-center min-h-screen">
      ...
      <div className="xl:items-center xl:flex xl:flex-col w-full">
        <div className={`xl:max-w-xl w-9/12 mx-1 p-2 ${listFavorites.length === 0 && 'h-screen'}`}>
        ...
        <div className="xl:max-w-xl w-9/12 p-1 gap-1 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4">
          {
            listFavorites.length > 0
