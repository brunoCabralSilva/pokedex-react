      ...
      <div className="bg-black flex flex-col w-full">
        ...
        <section className="w-full flex flex-col justify-center items-center">
          <div className="grid grid-cols-2 md:grid-cols-4 w-full">
            <div className="h-60vh md:h-85vh row-span-2 col-span-2 md:col-span-4 p-1 relative">
              <Slider
            ...
            <div className="col-span-1 md:col-span-2 h-30vh md:h-60vh p-1 relative">
              <div className="flex items-end w-full p-1 h-full bg-mini-transp hover:bg-transp transition duration-500 absolute z-40">
            ...
            <div className="row-span-2 h-30vh md:h-60vh p-1 relative">
              <div className="flex items-end w-full h-full bg-mini-transp hover:bg-transp transition duration-500 absolute z-40">
                <p className="text-white bg-gradient-to-r w-full from-min-transp to-transp text-xl font-bold p-3">Cards</p>
              </div>
              <Slider
